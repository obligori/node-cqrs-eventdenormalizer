...
const structureParser = require('#/structure/structureParser');
const ViewBuilder = require('#/definitions/viewBuilder');
const EventExtender = require('#/definitions/eventExtender');
const PreEventExtender = require('#/definitions/preEventExtender');
