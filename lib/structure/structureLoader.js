...
const structureParser = require('denormalizer/lib/structure/structureParser');
const ViewBuilder = require('denormalizer/lib/definitions/viewBuilder');
const EventExtender = require('denormalizer/lib/definitions/eventExtender');
const PreEventExtender = require('denormalizer/lib/definitions/preEventExtender');
const Collection = require('denormalizer/lib/definitions/collection');
