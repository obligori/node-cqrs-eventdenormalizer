...
const customLoader = require('denormalizer/lib/structure/customLoader');
const structureLoader = require('denormalizer/lib/structure/structureLoader');
const TreeExtender = require('denormalizer/lib/structure/treeExtender');
const EventDispatcher = require('denormalizer/lib/eventDispatcher');
const ReplayHandler = require('denormalizer/lib/replayHandler');
const RevisionGuard = require('denormalizer/lib/revisionGuard');
const revisionGuardStore = require('denormalizer/lib/revisionGuardStore');
